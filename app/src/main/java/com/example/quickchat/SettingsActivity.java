...
import com.example.quickchat.StatusActivity;
import com.example.quickchat.Users;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        circleImageView = findViewById(R.id.settings_display_pic);
        displayName = findViewById(R.id.settings_display_name);
        displayStatus = findViewById(R.id.settings_status);
        changeImageButton = findViewById(R.id.settings_change_img);
...
//                                 saveInSharedPreference(imageName, url);
    ...
    private void statusChange(){
        ...
        String status = changeStatusButton.getText().toString();
